...
In my PhD, I aim to explore how **metamaterial** techniques can serve as interfaces that allow **AI** to assist humans in real-world applications, especially in **education** scenarios.
